    ...
    return (
      <div className="footer">
        <div className="socialIcons">
          <a className="facebookIcon" href="https://www.facebook.com/thevillagegrind/" target="_blank">
            {/*<div className="facebookIcon"></div>*/}
            <i className="fa fa-facebook-square" aria-hidden="true"></i>
          </a>
          <a className="instagramIcon" href="https://www.instagram.com/thevillagegrind/" target="_blank">
            {/*<div className="instagramIcon"></div>*/}
            <i className="instagramIcon fa fa-instagram" aria-hidden="true"></i>
          </a>
        </div>
